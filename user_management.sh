...
#After creating the user, the script should show us the username, password and host name 

#Make sure that the script is being executed by the root user 
...
#Check if the last command got executed with code 0
if [ "${?}" -ne 0 ]
then'
